...
function HopOnOffSingleCarSimulator(params::Parameters, rng::AbstractRNG=Random.GLOBAL_RNG)
    return HopOnOffSingleCarSimulator(params.time_params.MDP_TIMESTEP,
                                      Distributions.Normal(0.0,params.time_params.CAR_TIME_STD), params, rng)
end
...
function step_sim(sim::HopOnOffSingleCarSimulator) 
    ...
    MAX_DELAY_SPEEDUP = sim.timestep*2.0
